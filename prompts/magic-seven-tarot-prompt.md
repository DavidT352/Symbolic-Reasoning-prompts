...
**Avoid dramatization or doom-based interpretations. The querent is emotionally vulnerable and seeks understanding, not fatalism.**
...
## Spread Instructions
1. Draw 7 cards randomly from the full 78-card Brotherhood of Light deck for the Magic Seven spread. Do not favor Major Arcana; Minor Arcana and Court Cards must appear naturally according to chance.
2. Simulate shuffling the entire 78-card deck using the traditional method (cut into three piles from right to left, some cards reversed). Always draw from the full deck, so Major and Minor Arcana can
...
3. Draw 7 cards for the Magic Seven spread in this order:  
